...
import ConsultarLogs from "./pages/logs/consultar"
    ...
    <div className="app">
      <aside className="sidebar">
        ...
        <div className="menu-block">
          ...
          <Link className="menu-item" to="/logs/consultar">Consultar</Link>
        </div>
      ...
      <main className="content">
        <Routes>
          ...
          <Route path="/logs/consultar" element={<ConsultarLogs />} />
